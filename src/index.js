 ...
 * Dynamically spreads all enriched fields generated by analyzer.js.
 */
function formatReportPayload(site, rawOutput, reportData) {
  return {
    ...
    ...reportData, // Spreads all Gemini structured output automatically
  };
}
